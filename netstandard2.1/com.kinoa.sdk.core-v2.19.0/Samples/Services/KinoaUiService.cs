    ...
    public class KinoaUiService : KinoaSingleton<KinoaUiService>
    {
            ...
            List<Resource> resources, InAppStorePackages packages, CancellationToken cancellationToken)
        {
            switch (clickConfig)
            {
                ...
                case InAppCustomClickConfiguration custom:
                    //TODO: Implement the game-specific handler dispatched by custom.CtaName
                    //      (e.g., Share / Invite / Copy / etc. — names are configured on the dashboard).
                    Debug.Log($"[KinoaUiService] Custom CTA clicked: CtaName={custom.CtaName}.");
                    break;
